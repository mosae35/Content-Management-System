    ...
    <header class="header" id="site-header">
        <div class="container">
            <div class="header-content-wrapper">
                <div class="logo">
                    <div class="logo-text">
                        <div class="logo-title">{{$setting->name}}</div>
                    </div>
                </div>
            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >{{$setting->name}}</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="form_search-wrap">
                <form method="get" action="{{url('post/results')}}" >
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5a4e1f3ba1f82557"></script>
